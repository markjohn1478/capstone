...
export default function MemberProfile() {
  ...
  const BASE_URL = "http://127.0.0.1:8000/storage/";  // Change this to your Laravel app's public URL
  ...
  const fields = [
    ...
    { label: "Barangay Indigency", value: docs.barangay_indigency, icon: "image", key: "image" },
    { label: "Medical Certificate", value: docs.medical_certificate, icon: "image", key: "image" },
    { label: "2x2 Picture", value: docs.picture_2x2, icon: "image", key: "image" },
    { label: "Birth Certificate", value: docs.birth_certificate, icon: "image", key: "image" },
  ];
